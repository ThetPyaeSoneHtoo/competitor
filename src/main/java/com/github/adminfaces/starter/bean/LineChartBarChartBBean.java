 ...
 */
@ManagedBean(name = "lineChartBarChartBBean")
public class LineChartBarChartBBean implements Serializable {
    ...
    private void createBarModel() {
        ...
        barModel.setTitle("Pan United - Truck Capacity (m3)");
        ...
        barModel1.setTitle("Pan United - Volume per month (m3)");
    ...
    private void createLineModels() {
        ...
        lineModel2.setTitle("Pan United - No. of Plant");
        ...
        lineModel.setTitle("Pan United - No. of Truck");
